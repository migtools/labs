...
There are currently 4 phases within a migration where migration hooks can be run. One hook may be run per phase for a maximum total of 4 hooks per migration, and hooks in any phase may be run either on the source or destination cluster.
