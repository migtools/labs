...
=== Exercise
In this exercise, we will be using Migration Hooks to address a MediaWiki configuration setting change (https://www.mediawiki.org/wiki/Manual:$wgServer[$wgServer]) that is needs to be updated to the destination OCP 4 cluster post application migration.  Let's get started.
