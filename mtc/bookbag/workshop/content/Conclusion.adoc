...
*Congratulations* and *Thank You* for participating in the OpenShift Migration Tookit for Containers (MTC) Lab. We hope you have found it to be both informative and thorough. By now you have completed the following activities:
