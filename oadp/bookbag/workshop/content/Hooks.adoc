...
pre.hook.backup.velero.io/command='["/bin/bash", "-c", "touch /var/opt/mssql/data/lab-pre-backup"]' \
post.hook.backup.velero.io/command='["/bin/bash", "-c", "touch /var/opt/mssql/data/lab-post-backup"]'
----
