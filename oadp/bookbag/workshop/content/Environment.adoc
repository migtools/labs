...
You copy `admin` password here if you need it.
[source,bash,role=copy]
----
%ocp4_password%
----
...
In the next lab, we will be using the buttons above to login as admin on the terminal.
