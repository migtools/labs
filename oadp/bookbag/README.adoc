...
During content development you will likely want to pass these yourself.
...
If your AgnosticD configuration deploys infrastructure for several students then set `openshift_homeroom_url` for each user:
